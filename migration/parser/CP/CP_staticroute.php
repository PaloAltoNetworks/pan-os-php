...
Destination     Gateway         Genmask         Flags   MSS Window  irtt Iface
        ...
        */
        ...
        {
            /*
            [0] => 165.225.80.40    DEST
            [1] => 0.0.0.0          GW
            [2] => 255.255.255.255  MASK
            [3] => UHD
            [4] => 0
            [5] => 0
            [6] => 0
            ...
            if( isset( $entry[1] ) && $entry[1] == "0.0.0.0" )
            {
                $int_name = $entry[7];
                $ipv4 = $entry[0];
                ...
                if( $vlan != "" )
                {
                    ...
                    if( $tmp_sub === null )
                    {
                        print "    - add subinterface interface: " . $int_name. "." . $vlan . "\n";
        ...
        foreach( $routes as $key => $entry )
        {
            ...
            print $tmpRoute->destination()."\n";
            print $tmpRoute->nexthopIP()."\n";
