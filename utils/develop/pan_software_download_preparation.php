...
if( $configType == 'panos' )
{
    if( $inputConnector->serial != "" )
    {
        ...
        $string .= print_string( $fw_con );
        $new_device_array[ $fw_con->info_serial ] = print_string( $inputConnector );
    }
    else
    {
        $inputConnector->refreshSystemInfos();

        $string .= print_string( $inputConnector );
        $new_device_array[ $inputConnector->info_serial ] = print_string( $inputConnector );
    }
}
elseif( $configType == 'panorama' )
{
    ...
    foreach( $device_serials as $child )
    {
        ...
        $string .= print_string( $fw_con );
        $new_device_array[ $fw_con->info_serial ] = print_string( $fw_con );
    }
}
