...
function ruleCleaner_PhaseX()
{
    ...
    $return = getConfig($configInput, $debugAPI, True);
    ...
    $return = determineConfig($xmlDoc, $configInput, $inputConnector, $location);
    ...
    //
    main($subSystem, $configInput, $pan, $inputConnector, $configOutput, $ruleStats, $skipIfLastReportIsMoreThanX_DaysOld, $dryRun );
}

function main($subSystem, $configInput, $pan, $inputConnector, $configOutput, $ruleStats, $skipIfLastReportIsMoreThanX_DaysOld, $dryRun )
{
