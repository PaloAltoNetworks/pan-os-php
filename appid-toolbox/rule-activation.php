...
function ruleActivation_Phase5()
{
    ...
    $return = getConfig($configInput, $debugAPI, False);
    ...
    //
    main($subSystem, $configInput, $pan, $inputConnector, $configOutput, $dryRun );

}

function main( $subSystem, $configInput, $pan, $inputConnector, $configOutput, $dryRun )
{
