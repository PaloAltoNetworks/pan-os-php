...
function ruleMarker_PhaseX()
{
    ...
    $return = getConfig($configInput, $debugAPI);
    ...
    //
    main($subSystem, $configInput, $pan, $inputConnector, $configOutput );
}

function main( $subSystem, $configInput, $pan, $inputConnector, $configOutput )
{
