...
function ruleCloner_PhaseX()
{
    ...
    //
    main($subSystem, $configInput, $pan, $inputConnector, $configOutput, $ruleStats, $bundleApiCalls );
}


function main( $subSystem, $configInput, $pan, $inputConnector, $configOutput, $ruleStats, $bundleApiCalls )
{
